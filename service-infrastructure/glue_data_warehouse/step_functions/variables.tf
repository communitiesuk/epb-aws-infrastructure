variable "prefix" {
  type        = string
  description = "Resource name prefix, e.g. epb-integration-domestic"
}
...
variable "glue_populate_rr_job_name" {
  type        = string
  description = "Name of the Glue job that populates the recommendations catalog using the materialized view."
}
