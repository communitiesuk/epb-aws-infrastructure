...
module "secrets" {
  ...
  secrets = {
    ...
    "EPB_OPEN_DATA_ONELOGIN_CLIENT_ID" : var.parameters["EPB_OPEN_DATA_ONELOGIN_CLIENT_ID"]
    "EPB_OPEN_DATA_ONELOGIN_HOST_URL" : var.parameters["EPB_OPEN_DATA_ONELOGIN_HOST_URL"]
...
module "data_frontend_application" {
  ...
  secrets = {
    ...
    "EPB_AUTH_SERVER" : module.secrets.secret_arns["EPB_AUTH_SERVER"],
    "EPB_DATA_WAREHOUSE_API_URL" : module.secrets.secret_arns["EPB_DATA_WAREHOUSE_API_URL"]
    "ONELOGIN_CLIENT_ID" : module.secrets.secret_arns["EPB_OPEN_DATA_ONELOGIN_CLIENT_ID"]
    "ONELOGIN_HOST_URL" : module.secrets.secret_arns["EPB_OPEN_DATA_ONELOGIN_HOST_URL"]
  }
  parameters = merge(module.parameter_store.parameter_arns, {
