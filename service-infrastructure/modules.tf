...
module "secrets" {
  ...
  secrets = {
    ...
    "RDS_DATA_SERVICE_PASSWORD" : module.rds_data_service.rds_db_password,
    "RDS_DATA_SERVICE_USERNAME" : module.rds_data_service.rds_db_username,
    "RDS_DATA_SERVICE_CONNECTION_STRING" : module.rds_data_service.rds_db_connection_string,
